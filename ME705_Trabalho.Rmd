...
hist(thetas[seq(from = 5000, to = 10000, by = 10), 1])
hist(thetas[seq(from = 5000, to = 10000, by = 10), 2])
hist(thetas[seq(from = 5000, to = 10000, by = 10), 3])
hist(thetas[seq(from = 5000, to = 10000, by = 10), 4])
hist(thetas[seq(from = 5000, to = 10000, by = 10), 5])
hist(thetas[seq(from = 5000, to = 10000, by = 10), 6])
hist(thetas[seq(from = 5000, to = 10000, by = 10), 7])
```
...
plot(type = "l",thetas[seq(from = 5000, to = 10000,by = 10), 1])
plot(type = "l",thetas[seq(from = 5000, to = 10000,by = 10), 2])
plot(type = "l",thetas[seq(from = 5000, to = 10000,by = 10), 3])
plot(type = "l",thetas[seq(from = 5000, to = 10000,by = 10), 4])
plot(type = "l",thetas[seq(from = 5000, to = 10000,by = 10), 5])
plot(type = "l",thetas[seq(from = 5000, to = 10000,by = 10), 6])
plot(type = "l",thetas[seq(from = 5000, to = 10000,by = 10), 7])
```

```{r}
apply(thetas[seq(from= 5000,to = 10000,by = 10), ], 2, FUN=mean)
fit.lm$coefficients
apply(thetas[seq(from= 5000,to = 10000,by = 10), ], 2, FUN=var)
diag(vcov(fit.lm))
```
...
kable(tabela, booktabs = TRUE, caption = 'Tabela 1: R chapéu de cada parâmetro', align = 'l', format = 'latex') %>%
